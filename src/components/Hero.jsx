        ...
        <section className="bg-white dark:bg-gray-900" >
            ...
            <div className="grid z-50 max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                ...
                >
                    ...
                    <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white"><span className="bg-gradient-to-r from-purple-500 via-orange-600 to-amber-400 bg-clip-text text-transparent">GenioHub</span>: Elevate Your Business with Cutting-Edge AI Solutions</h1>
                    <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-lg dark:text-gray-400">Empowering Enterprises with Intelligent AI Services for Smarter Operations and Enhanced Customer Experiences..</p>
